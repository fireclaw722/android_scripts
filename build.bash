...
addOTA() {
        ...
        FLASK_APP=updater/app.py flask addrom -f Cerulean-15.1-$datetime-$device.zip -d $device -v 15.1 -t "$updaterDate" -r $releasetype -s $(stat --printf="%s" /srv/builds/$device/full/Cerulean-15.1-$datetime.zip) -m $(md5sum /srv/builds/$device/full/Cerulean-15.1-$datetime.zip | awk '{ print $1 }') -u https://ota.jwolfweb.com/builds/$device/full/Cerulean-15.1-$datetime.zip
